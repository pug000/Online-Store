export const selfEsteem = () => {
  ...
  console.log('Ссылка на таск: https://github.com/rolling-scopes-school/tasks/blob/master/tasks/online-store/README.md');
  console.log('Ванилла ТС: https://rolling-scopes-school.github.io/pug000-JSFE2022Q1/online-store/');
  console.log('Реакт ТС: https://rolling-scopes-school.github.io/pug000-JSFE2022Q1/online-store-react/');
  console.log(`
  ...
  можно отобразить только популярные товары +0
